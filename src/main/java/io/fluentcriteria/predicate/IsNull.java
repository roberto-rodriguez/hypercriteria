 ...
 * @author rrodriguez
 */
public class IsNull extends PredicateWithExpression {

    public IsNull(String fieldPath) {
        super(fieldPath);
    }

    public IsNull(BaseExpression expression) {
        super(expression);
    }

    @Override
    public Predicate toPredicate(QueryContext ctx) {
        return getExpression(ctx).isNull();
    }
